...
<body>
	...
	<form action="/sub17/link6" method="post">
		...
		계약명 <input type="text" name="contactName" value="${customer.contactName}"/> <br />
		주소 <input type="text" name="city" value="${customer.city }"/> <br />
		도시 <input type="text" name="address" value="${customer.address}"/> <br />
